...
async function stats() {
    ...
    document.getElementById('servers').cantidadtotal = 100
    document.getElementById('commands').cantidadtotal = 100
    document.getElementById('users').cantidadtotal = 100
    document.getElementById('votes').cantidadtotal = 100
}
